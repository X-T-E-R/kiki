...
| `/web` | — | 在 web UI 中打开当前会话：选择一个运行中的实例进行连接，或在 TUI 退出后新开一个前台服务器。参见 [`kiki web`](./command.md#kiki-web) | 是 |
...
- [键盘快捷键](../reference/keyboard.md) — TUI 键盘操作速查
- [内置工具](../reference/tools.md) — Agent 可调用的工具完整参考
