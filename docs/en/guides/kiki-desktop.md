# Kiki desktop for Windows

Kiki desktop is distributed as a per-user NSIS installer for 64-bit Windows. Official installers, updater signatures, SHA256 checksums, and versioned updater manifests are retained on [GitHub Releases](https://github.com/X-T-E-R/kiki/releases).
