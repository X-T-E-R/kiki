import { ErrorCodes } from '@kiki/node-sdk';
...
export const CLI_USER_AGENT_PRODUCT = 'kiki-cli';
export const KIMI_CODE_CLI_USER_AGENT_PRODUCT = 'kimi-code-cli';
...
// User-Agent suffix for the `kiki web` host, distinguishing web-UI traffic
// from direct CLI runs without changing the configured product token.
