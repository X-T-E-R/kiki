...
export const SETTINGS_SEARCH_SPEC: readonly SettingsSearchSpecEntry[] = [
  ...
  { section: 'agents', cardId: 'st-card-named-agents', titleKey: 'st.namedAgents.title', keywordKeys: ['st.namedAgents.readOnlyHint', 'st.namedAgents.modelPin', 'st.namedAgents.route'] },
