...
export const en = {
  ...
  'st.group.about': 'About & updates',
  'st.scope.label': 'Scope',
  'st.scope.app': 'App',
  'st.scope.server': 'Server',
  'st.scope.workspace': 'Workspace',
  'st.purpose.general': 'Language, appearance, composer behavior, desktop integration, and new-session defaults for this device.',
  ...
  'st.purpose.capabilities': 'Skills, MCP servers, tool policy, runtime, experimental flags, and advanced config.',
