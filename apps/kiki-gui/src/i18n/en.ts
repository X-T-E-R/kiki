...
export const en = {
  ...
  'composer.agentProfileHeading': 'Agent',
  ...
  'st.subagents.hint':
    'The pool lists the models available to subagents. Deny entries always block a model; enforce pool upgrades the pool to a hard allowlist.',
  'st.subagents.pool': 'Subagent model pool',
  ...
  'st.subagents.default': 'Default subagent model',
  'st.subagents.poolEmpty': 'No subagent pool models configured.',
  'st.subagents.force': 'Force every subagent to use the default subagent model',
  ...
  'st.subagents.enforcePoolHint': 'When off, explicit profile/tool aliases may use a non-denied model outside the pool.',
  ...
  'st.subagents.issueDefaultRequired': 'Choose a default subagent model for a non-empty pool or force mode.',
  'st.subagents.issueDefaultNotInPool': 'The default subagent model must be one of the pool entries.',
