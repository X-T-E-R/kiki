...
export const en = {
  ...
  'st.plugins.contrib.skills': '{count} skills',
  'st.plugins.contrib.mcp': '{count} MCP servers',
  'st.plugins.contrib.hooks': '{count} hooks',
  'st.plugins.contrib.commands': '{count} commands',
  ...
  'st.plugins.sourceHint': 'Set [plugins] marketplace_url in config.toml (or this field) to a JSON catalog. Leave it empty to skip remote fetching.',
  'st.plugins.sourceSave': 'Save catalog URL',
  'st.plugins.sourceSaved': 'Marketplace source saved and echoed by the server.',
  'st.plugins.sourceUnconfigured': 'No marketplace is configured. Save a catalog URL above — a JSON file or https URL with a "plugins" array — then entries appear here. Until then nothing is fetched.',
