...
| [deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | [`47f943859bef60e4160492346772ded9b24f765a`](https://github.com/deepseek-ai/deepseek-harness/commit/47f943859bef60e4160492346772ded9b24f765a) | MIT | Conversation-shell single-tree phase model (hero/active/settling) with the resident composer; shared content-width axis; sticky composer fade mask; hero composition with workspace chip and warm glow; turn-level running signal with elapsed clock; reasoning-row summary rule and scan animation; system-injection producer labels and bounded bodies; tool-row failure-first summaries; queue collapse header and inline edit; user-bubble `@`/`/` reference chips; end-of-turn readout |
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | [`62651870dd18ad3d9bf54a9cb934b75d0fbaf639`](https://github.com/zhu1090093659/dsh-web-ui/commit/62651870dd18ad3d9bf54a9cb934b75d0fbaf639) | Apache-2.0 | Grouped collapsible capability-card presentation (group header with count and chevron over child rows) for the /capabilities page |
