...
const persistedAgentProfileCaches = new WeakMap<Scope, Map<string, PersistedAgentProfileCacheEntry>>();
...
function persistedAgentProfileCache(core: Scope): Map<string, PersistedAgentProfileCacheEntry> {
