...
//
// "Without minidb" search baseline over the SAME real ~/.kiki sessions
...
//
// Run:  node --import tsx bench/search-baseline.ts [--data ~/.kiki]
...
const DATA = path.resolve(arg('data', path.join(os.homedir(), '.kiki')));
