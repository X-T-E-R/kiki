...
export const en = {
  ...
  'st.purpose.plugins': 'Installed plugins on the connected Server: enabled state, errors, and contribution summaries.',
  ...
  'st.plugins.hint': 'Enabled state, errors, and what each installed plugin contributes. Browsing and installing from the marketplace lands in a later batch.',
