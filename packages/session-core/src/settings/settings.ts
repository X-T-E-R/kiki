...
export const SETTINGS_SEARCH_SPEC: readonly SettingsSearchSpecEntry[] = [
  ...
  { section: 'general', cardId: 'st-card-composer', titleKey: 'st.composer.title', keywordKeys: ['st.composer.sendShortcut', 'st.composer.persistDrafts', 'st.transcript.foldSteps'], synonyms: ['timeline', '时间线', 'fold steps', '折叠', '工具步骤'] },
