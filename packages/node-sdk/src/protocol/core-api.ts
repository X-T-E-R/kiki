...
import type { CronTaskSnapshot } from './cron';
...
export interface ExportSessionPayload {
  ...
  /**
   * When true, the active global diagnostic log (`$KIKI_HOME/logs/kimi-code.log`)
...
export type { GlobalMcpServerConfig, McpServerSource };
