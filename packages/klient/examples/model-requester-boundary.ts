 ...
 * Kimi home (`KIKI_HOME` or `~/.kiki`), resolves `IModelCatalog`
...
} from '@kiki/agent-core-v2/kosong/contract/errors';
import type { ToolCall } from '@kiki/agent-core-v2/kosong/contract/message';
