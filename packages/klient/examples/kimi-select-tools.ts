...
import { renderLoadableToolsAnnouncement } from '@kiki/agent-core-v2/agent/toolSelect/dynamicTools';
import { UNKNOWN_CAPABILITY } from '@kiki/agent-core-v2/kosong/contract/capability';
import type { Message } from '@kiki/agent-core-v2/kosong/contract/message';
...
import type {
  ModelRequestInput,
  ModelRequester,
} from '@kiki/agent-core-v2/kosong/model/modelRequester';
import { ModelRequesterImpl } from '@kiki/agent-core-v2/kosong/model/modelRequesterImpl';
import { IProtocolAdapterRegistry } from '@kiki/agent-core-v2/kosong/protocol/protocol';
...
async function probeLiveKimiProviders(): Promise<void> {
  const homeDir = process.env['KIKI_HOME'] ?? join(homedir(), '.kiki');
