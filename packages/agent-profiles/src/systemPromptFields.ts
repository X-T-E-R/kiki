...
const SECTION_MARKERS = [
  ...
  [SYSTEM_PROMPT_FIELD_IDS.intentToolUse, '# Intent, Continuity, and Tool Use', '# General Guidelines for Coding'],
  [SYSTEM_PROMPT_FIELD_IDS.coding, '# General Guidelines for Coding', '# General Guidelines for Research and Data Processing'],
