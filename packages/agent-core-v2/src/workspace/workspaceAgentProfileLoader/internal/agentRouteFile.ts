/**
 * `workspaceAgentProfileLoader` domain — strict named profile-route sidecar parser.
 *
 * Parses the serializable specialization fields accepted below and rejects
 * unknown keys, invalid route identity, and unsafe prompt composition.
 */
