...
import { isSourceSubagentLease } from '#/app/agentProfileCatalog/subagentLease';
import {
...
import type { AgentFileDefinition, AgentFileScopedBinding } from './types';
      ...
      if (definition === undefined) {
        try {
          definition = parseAgentFileText({
            ...
            text: await fs.readText(canonicalPath),
            definitionId,
